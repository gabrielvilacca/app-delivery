          ...
          <div>
            <div className="w-full space-y-3">
              ...
              <p className="text-sm font-light text-gray-500 whitespace-pre-wrap">
                batata crocante + cheddar cremoso 🧡 + bacon em tiras suculentas
                🥓 🥫 Molhos especiais: 🌿 Verde temperado | 🍯 Barbecue | 🧀
                Cheddar/Maionese
              </p>
            </div>
...
export default FritasOverloadedVend;
