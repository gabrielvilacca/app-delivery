          ...
          <div>
            <div className="w-full space-y-3">
              ...
              <p className="text-sm font-light text-gray-500 whitespace-pre-wrap">
                Pão de cacau macio, recheado com ganache de chocolate meio
                amargo, morangos frescos selecionados e um delicioso creme de
                baunilha. Perfeito para quem ama uma sobremesa gourmet
                irresistível.
              </p>
            </div>
