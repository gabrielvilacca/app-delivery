          ...
          <div>
            <div className="w-full space-y-3">
              ...
              <p className="text-sm font-light text-gray-500 whitespace-pre-wrap">
                ...
                duas fatias de cheddar, uma fatia de queijo prato, bacon
                crocante em dobro, folhas frescas de alface americana, toque
                especial de sal grosso e muito sabor. Acompanha batatas fritas
                rústicas.
              </p>
            </div>
...
export default TripleBaconArte;
