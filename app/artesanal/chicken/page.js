...
const ChickenArte = () => {
  ...
  const BASE_PRICE = 24.9; // Preço base do combo
          ...
          <div>
            <div className="w-full space-y-3">
              ...
              <p className="text-sm font-light text-gray-500 whitespace-pre-wrap">
                Hambúrguer suculento envolvido por uma generosa carne de frango
                empanada, super crocante com uma salada. Tudo isso no pão
                brioche leve e dourado, pra quem ama sabor com personalidade.
              </p>
            </div>
            <div className="mt-3 md:mt-6">
              <div className="flex flex-wrap font-semibold items-center gap-2">
                <span className="text-base text-green-500">R$ 24,90</span>
