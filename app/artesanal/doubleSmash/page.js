...
import DoubleSmash from "@/public/artesanal/double-bacon.png";
          ...
          <div>
            <div className="w-full space-y-3">
              ...
              <p className="text-sm font-light text-gray-500 whitespace-pre-wrap">
                Dois hambúrgueres artesanais grelhados no fogo, queijo cheddar
                derretido, fatias generosas de bacon crocante, tomate fresco e
                maionese cremosa, tudo no pão brioche levemente tostado. Um
...
export default DoubleSmashArte;
