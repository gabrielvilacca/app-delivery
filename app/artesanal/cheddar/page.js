...
const CheddarArte = () => {
  ...
  const BASE_PRICE = 23.9; // Preço base do combo
          ...
          <div>
            <div className="w-full space-y-3">
              ...
              <p className="text-sm font-light text-gray-500 whitespace-pre-wrap">
                Pão australiano, dois hambúrgueres artesanais grelhados, uma
                explosão de queijo cheddar derretido em camadas e um creme de
                cheddar no topo. Tudo isso com um toque levemente picante na
                base pra fechar com chave de ouro.
              </p>
            </div>
            <div className="mt-3 md:mt-6">
              <div className="flex flex-wrap font-semibold items-center gap-2">
                <span className="text-base text-green-500">R$ 23,90</span>
