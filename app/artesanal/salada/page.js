          ...
          <div>
            <div className="w-full space-y-3">
              ...
              <p className="text-sm font-light text-gray-500 whitespace-pre-wrap">
                Queijo cheddar derretido, alface americana crocante, tomate
                fresco, maionese cremosa e uma finalização irresistível com
                geleia de pimenta artesanal. Tudo isso envolto no nosso molho
                exclusivo da casa.
              </p>
            </div>
