...
import BarcaCheddar from "@/public/artesanal/barca.jpeg";
...
const BarcaCheddarArte = () => {
  const router = useRouter();

  const BASE_PRICE = 25.99; // Preço base do combo
          ...
          <div>
            <div className="w-full space-y-3">
              ...
              <p className="text-sm font-light text-gray-500 whitespace-pre-wrap">
                ...
                Farofa de bacon por todo lado E batata pra fechar o combo com
                chave de ouro.. SERVE 2 PESSOAS
              </p>
            </div>
            <div className="mt-3 md:mt-6">
              <div className="flex flex-wrap font-semibold items-center gap-2">
                <span className="text-base text-green-500">R$ 25,99</span>
...
export default BarcaCheddarArte;
