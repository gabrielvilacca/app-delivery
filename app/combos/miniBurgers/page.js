...
const MiniBurgersComb = () => {
  const router = useRouter();

  const BASE_PRICE = 32.9; // Preço base do combo
          ...
          <div>
            <div className="w-full space-y-3">
              ...
              <p className="text-sm font-light text-gray-500 whitespace-pre-wrap">
                🍔 Mini Burgers no Brioche – carne bovina suculenta + cheddar
                derretido 🧀 🍟 Batata Cheddar & Bacon – fritas crocantes +
                cheddar cremoso 🧡 + bacon triturado 🥓 + cebolinha 🌱 🧅 Onion
                Rings – cebola empanada crocante + molho cheddar 🧀
              </p>
            </div>
            <div className="mt-3 md:mt-6">
              <div className="flex flex-wrap font-semibold items-center gap-2">
                <span className="text-base text-green-500">R$ 32,90</span>
...
export default MiniBurgersComb;
