          ...
          <div>
            <div className="w-full space-y-3">
              ...
              <p className="text-sm font-light text-gray-500 whitespace-pre-wrap">
                2 carnes smash 🥩🔥 + cheddar derretido 🧀 + molho especial 🥤
                Guaraná geladinho 🟢 🍪 Cookie de sobremesa 🍫
              </p>
            </div>
...
export default DoubleCheeseburgerComb;
