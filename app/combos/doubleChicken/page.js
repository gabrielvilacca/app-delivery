          ...
          <div>
            <div className="w-full space-y-3">
              ...
              <p className="text-sm font-light text-gray-500 whitespace-pre-wrap">
                2 filés de frango empanado crocante 🍗 + alface 🥬 + tomate 🍅 +
                maionese cremosa 🤍 🥤 Coca-Cola gelada 🥶 🍪 Cookies doces na
                medida 🍫
              </p>
            </div>
...
export default DoubleChickenComb;
