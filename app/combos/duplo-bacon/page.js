...
import DuploBacon from "@/public/combos/duploBurger.jpeg";
          ...
          <div>
            <div className="w-full space-y-3">
              ...
              <p className="text-sm font-light text-gray-500 whitespace-pre-wrap">
                🍔 Smash Duplo – duas carnes suculentas 🥩🔥 + cheddar derretido
                🧀 🍔 Bacon Burger – carne smash 🥩 + bacon crocante 🥓 +
                cheddar 🧡{" "}
              </p>
            </div>
