...
const GrandeAcai = () => {
  ...
  const BASE_PRICE = 25.9; // Preço base do combo
  ...
  const handleAddToCart = () => {
    ...
    alert(`Combo Grande adicionado ${comboQuantity} vez(es)!`);
          ...
          <div>
            <div className="w-full space-y-3">
              ...
              <p className="text-sm font-light text-gray-500 whitespace-pre-wrap">
                ...
                servido em grande estilo, com adicionais grátis 🍌🍓🍫🥜 pra
                você montar do seu jeito.
              </p>
            </div>
            <div className="mt-3 md:mt-6">
              <div className="flex flex-wrap font-semibold items-center gap-2">
                <span className="text-base text-green-500">R$ 25,90</span>
              </div>
            </div>
          </div>
        </div>
