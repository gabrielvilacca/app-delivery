...
import Barca from "@/public/sorvetes/barca.jpeg";
import {
  X,
  ShoppingBag,
  CheckCircle,
...
const BarcaAcai = () => {
  ...
  const BASE_PRICE = 27.9; // Preço base do combo
  ...
  const handleAddToCart = () => {
    ...
    alert(`Combo Barca adicionado ${comboQuantity} vez(es)!`);
          ...
          <div>
            <div className="w-full space-y-3">
              ...
              <p className="text-sm font-light text-gray-500 whitespace-pre-wrap">
                ma explosão de sabor e fartura! Açaí cremoso, geladinho, servido
                em grande estilo, com adicionais grátis 🍌🍓🍫🥜 pra você montar
                do seu jeito. 👉 Ideal para compartilhar com a galera ou se
                deliciar sozinho(a) sem pressa!
              </p>
            </div>
            <div className="mt-3 md:mt-6">
              <div className="flex flex-wrap font-semibold items-center gap-2">
                <span className="text-base text-green-500">R$ 27,90</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-4 mx-4 rounded-xl shadow-sm">
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <CheckCircle
                size={20}
                className={totalAcai === 8 ? "text-green-600" : "text-gray-400"}
              />
            </div>
          </div>
