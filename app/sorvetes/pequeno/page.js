...
import Pequeno from "@/public/sorvetes/pequeno-medio.jpeg";
import {
  X,
  ShoppingBag,
  CheckCircle,
...
const PequenoAcai = () => {
  ...
  const BASE_PRICE = 10.9; // Preço base do combo
  ...
  const handleAddToCart = () => {
    ...
    alert(`Combo Pequeno adicionado ${comboQuantity} vez(es)!`);
          ...
          <div>
            <div className="w-full space-y-3">
              ...
              <p className="text-sm font-light text-gray-500 whitespace-pre-wrap">
                A porção perfeita para quem quer se refrescar com muito sabor!
                Cremoso, geladinho e com adicionais grátis 🍌🍫🥜 para você
                montar do seu jeito.
              </p>
            </div>
            <div className="mt-3 md:mt-6">
              <div className="flex flex-wrap font-semibold items-center gap-2">
                <span className="text-base text-green-500">R$ 10,90</span>
              </div>
            </div>
          </div>
        </div>
