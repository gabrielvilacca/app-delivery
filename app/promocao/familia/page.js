...
const FamiliaPromo = () => {
  ...
  const opcoes = {
    pizzas: [
      ...
      {
        sabor: "Mussarela",
        descricao: "Molho, mussarela, orégano.",
      },
      {
        sabor: "Toscana",
        descricao: "Molho, mussarela, Toscana e orégano.",
      },
    ],
    refrigerantes: [
      {
          ...
          <div>
            <div className="w-full space-y-3">
              ...
              <p className="text-sm font-light text-gray-500 whitespace-pre-wrap">
                2 Pizzas Grandes (Calabresa, Mussarela ou Toscana) + 1 Refri 2L
                à escolha{" "}
              </p>
            </div>
      ...
      <section className="space-y-4 pt-4 bg-[#f4f5f7]">
        ...
        <QuantityChoices
          ...
          onQuantityChange={(sabor, tipo) =>
            handleMultiChoiceChange("pizzas", sabor, tipo)
          }
          maxItems={2}
        />
