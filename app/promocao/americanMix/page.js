          ...
          <div>
            <div className="w-full space-y-3">
              ...
              <p className="text-sm font-light text-gray-500 whitespace-pre-wrap">
                ...
                Bolinhas de queijo 🌭 Pão com carne moída + cheddar + bacon
                crocante 🥫 Molho barbecue & Molho de maionese verde{" "}
              </p>
            </div>
...
export default AmericanMixComb;
