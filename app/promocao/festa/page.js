    ...
    <div className="bg-white p-4 mx-4 rounded-xl shadow-sm">
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex items-center space-x-2">
          ...
          <CheckCircle
            size={20}
            className={totalChosen === maxItems ? "text-green-600" : "text-gray-400"}
          />
        </div>
      </div>
...
const Festa = () => {
  ...
  const BASE_PRICE = 90.0; // Preço base do combo
  ...
  const handleAddToCart = () => {
    ...
    alert(`Combo festa adicionado ${comboQuantity} vez(es)!`);
  ...
  const opcoes = {
    pizzas: [
      ...
      {
        sabor: "Portuguesa",
        descricao: "Molho, mussarela, presunto, ovo, cebola, azeitona e orégano.",
      },
      {
        sabor: "Pepperoni",
      ...
      {
        sabor: "Vegetariana",
        descricao: "Molho, mussarela, pimentão, cebola, brócolis, milho e azeitona.",
      },
      {
  ...
  return (
    <main className="bg-[#f4f5f7]">
          ...
          <div>
            <div className="w-full space-y-3">
              ...
              <p className="text-sm font-light text-gray-500 whitespace-pre-wrap">
                4 Pizzas Grandes (sabores à escolha) + 2 Refrigerantes de 2L
              </p>
            </div>
            <div className="mt-3 md:mt-6">
              <div className="flex flex-wrap font-semibold items-center gap-2">
                <span className="text-base text-green-500">R$ 90,00</span>
      ...
      <section className="space-y-4 pt-4 bg-[#f4f5f7]">
        {/* Usando o componente para a escolha das Pizzas (até 4) */}
        <QuantityChoices
          title="Escolha o sabor das Pizzas"
          subtitle="Escolha 4 opções"
          options={opcoes.pizzas}
          selectedItems={escolhas.pizzas}
          onQuantityChange={(sabor, tipo) => handleMultiChoiceChange("pizzas", sabor, tipo)}
          maxItems={4}
        />
        ...
        <QuantityChoices
          ...
          onQuantityChange={(sabor, tipo) => handleMultiChoiceChange("refrigerantes", sabor, tipo)}
          maxItems={2}
        />
      </section>
